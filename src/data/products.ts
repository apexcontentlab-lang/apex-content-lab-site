...
export const productsData: DigitalProduct[] = [
  {
    ...
    tagline: "The complete step-by-step master framework for converting online attention into qualified email subscribers.",
    description: "An actionable digital blueprint detailing the exact visual architecture, content workflows, and email funnels needed to transform short-form video attention into owned audience members.",
    price: {
      display: "Free / $0",
      amount: 0,
      currency: "USD",
    ...
    targetAudience: "Coaches, consultants, creators, and agency owners looking to systematize subscriber acquisition."
  },
  {
    ...
    tagline: "Plug-and-play templates and copywriting frameworks to build a high-converting lead magnet in 48 hours.",
    description: "Stop guessing what your audience wants. This kit provides pre-structured templates, headline generators, and landing page copy frameworks engineered for rapid opt-in conversion.",
    price: {
      display: "$27",
      amount: 27,
      currency: "USD"
    ...
    gumroadUrl: siteConfig.integrations.gumroad.storeUrl,
    targetAudience: "Solopreneurs and small business owners needing an immediate, irresistible lead magnet asset."
  },
  {
    ...
    badge: "Email Funnel",
    tagline: "Tested 5-part automated email welcome sequence templates designed to build immediate brand authority.",
    description: "First impressions set the tone for client lifetime value. These pre-written, plug-and-play email templates deliver lead magnets, set expectations, and introduce core offers seamlessly.",
    price: {
      display: "$37",
      amount: 37,
      currency: "USD"
    ...
    gumroadUrl: siteConfig.integrations.gumroad.storeUrl,
    targetAudience: "Businesses with an existing lead magnet that struggle to turn new subscribers into buyers."
  },
  {
    ...
    tagline: "The ultimate operating bundle combining all Apex Content Lab blueprints, templates, and CRM diagrams.",
    description: "Get every digital asset, template kit, email sequence, and system flowchart produced by Apex Content Lab in a single complete growth architecture package.",
    price: {
      display: "$67",
      amount: 67,
      currency: "USD"
    ...
    gumroadUrl: siteConfig.integrations.gumroad.storeUrl,
    targetAudience: "Founders and growth specialists wanting the complete DIY toolkit for building scalable systems."
  }
];
